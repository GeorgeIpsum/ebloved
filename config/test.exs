...
config :ebloved, Ebloved.Repo,
  username: "postgres",
  password: "postgres",
  hostname: "localhost",
  port: 5433,
  database: "ebloved_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :ebloved, EblovedWeb.Endpoint,
  ...
  secret_key_base: "9dQasqIgNtHtTiaz5QsG9miIcIfPQpk799Rk2ye5rIfWREdUCY95q9tLMmVCZayw",
  server: false

# In test we don't send emails
config :ebloved, Ebloved.Mailer, adapter: Swoosh.Adapters.Test
